<template>
  <div class="gamer-container">
    ...
    <div class="gamer-card">
      ...
      <!-- Cargando -->
      <div v-if="loading" class="mt-8 text-center text-gray-400">Cargando productos...</div>
    </div>
        ...
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="Imagen del producto">
              <div class="image-preview-list flex items-center justify-center">
                <el-image
                  v-if="currentProduct.image && typeof currentProduct.image === 'string'"
...
const saveProduct = async () => {
  ...
  try {
    ...
    const url = currentProduct.value.id ? `/products/${currentProduct.value.id}` : "/products";
